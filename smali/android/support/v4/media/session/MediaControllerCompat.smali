...
.method public a(II)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$b;->adjustVolume(II)V
...
.method public b(II)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$b;->setVolumeTo(II)V
...
.method public d()Landroid/support/v4/media/session/MediaControllerCompat$d;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->getPlaybackInfo()Landroid/support/v4/media/session/MediaControllerCompat$d;
...
.method public g()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->c()Ljava/lang/CharSequence;
...
.method public i()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->getSessionActivity()Landroid/app/PendingIntent;
...
.method public j()Landroid/os/Bundle;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->a()Landroid/os/Bundle;
...
.method public l()Landroid/support/v4/media/session/MediaControllerCompat$e;
    .locals 1

    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaControllerCompat;->a:Landroid/support/v4/media/session/MediaControllerCompat$b;

    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->e()Landroid/support/v4/media/session/MediaControllerCompat$e;
...
.method public m()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->b()Z
...
.method public n()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->f()Z
