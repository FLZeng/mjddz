...
# direct methods
.method public static varargs a([Lkotlin/k;)Ljava/util/HashMap;
    .locals 2
    ...
    invoke-static {v0, p0}, Lkotlin/a/F;->a(Ljava/util/Map;[Lkotlin/k;)V
...
.method public static a(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/a/F;->a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 11
    :cond_2
    invoke-static {}, Lkotlin/a/C;->a()Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/a/F;->a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lkotlin/a/F;->b(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final a(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 13
    invoke-static {p1, p0}, Lkotlin/a/F;->a(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final a([Lkotlin/k;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    invoke-static {p1, p0}, Lkotlin/a/F;->a(Ljava/util/Map;[Lkotlin/k;)V
...
.method public static final b(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 3
    :cond_0
    invoke-static {p0}, Lkotlin/a/E;->a(Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs b([Lkotlin/k;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Lkotlin/a/F;->a([Lkotlin/k;Ljava/util/Map;)Ljava/util/Map;
...
.method public static c(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {p0}, Lkotlin/a/C;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs c([Lkotlin/k;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
