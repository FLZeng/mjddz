...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$h;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/session/f;->a:Landroid/support/v4/media/session/MediaSessionCompat$h;
...
.method public onVolumeChanged(Landroidx/media/VolumeProviderCompat;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/f;->a:Landroid/support/v4/media/session/MediaSessionCompat$h;

    iget-object v1, v0, Landroid/support/v4/media/session/MediaSessionCompat$h;->E:Landroidx/media/VolumeProviderCompat;
    ...
    iget v3, v0, Landroid/support/v4/media/session/MediaSessionCompat$h;->C:I

    iget v4, v0, Landroid/support/v4/media/session/MediaSessionCompat$h;->D:I
    ...
    .line 5
    iget-object p1, p0, Landroid/support/v4/media/session/f;->a:Landroid/support/v4/media/session/MediaSessionCompat$h;

    invoke-virtual {p1, v1}, Landroid/support/v4/media/session/MediaSessionCompat$h;->a(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
